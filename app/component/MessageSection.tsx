      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="surface-card panel-wash overflow-hidden rounded-[2.5rem] px-6 py-8 sm:px-10 sm:py-10">
          <div className="grid gap-6 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
            <div className="rounded-[2rem] bg-[linear-gradient(150deg,rgba(255,247,241,0.98)_0%,rgba(255,240,245,0.96)_100%)] p-6 sm:p-8">
            ...
            <div className="space-y-5 text-base leading-8 text-[#67505a] sm:text-lg">
              {coupleMessage.map((paragraph) => (
